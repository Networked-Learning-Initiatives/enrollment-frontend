...
angular.module('enrollmentFrontendApp').controller('TranscriptCtrl', function ($scope, $routeParams, ngTableParams, $filter) {
	...
	$scope.tableParams = new ngTableParams({
      ...
      getData: function($defer, params) {
        ...
        // else { //maybe don't need else bc of assigning to transcript before filtering every time
