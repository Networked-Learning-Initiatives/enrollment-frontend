...
angular.module('enrollmentFrontendApp').controller('TranscriptCtrl', ['$scope', '$routeParams', 'ngTableParams', '$filter', 'Upcoming', '$rootScope', function ($scope, $routeParams, ngTableParams, $filter, Upcoming, $rootScope) {
  $scope.transcript = [
    ...
    {title: 'Seven Technology Tools to Use in Your Teaching Today', start: 'Feb. 06, 2014', end: 'Feb. 6, 2014', startdt: '2014-2-6',  leader: 'Summers, Teggin',  credits: '1',  section: 313, role: 'learner'},
    ...
    {title: 'Designed Interaction Specialist Certificate', start: 'Feb. 4, 2014', end: 'April 15, 2014', startdt: '2014-4-15', enddt: '2014-4-15',  leader: 'Yaffe, Dan',  credits: '6*',  section: 430, role: 'learner'}
  ];
