...
angular.module('enrollmentFrontendApp').controller('TranscriptCtrl', ['$scope', '$routeParams', 'ngTableParams', '$filter', 'Upcoming', '$rootScope', function ($scope, $routeParams, ngTableParams, $filter, Upcoming, $rootScope) {
  $scope.transcript = [
    ...
    {title: 'Field Trip to the Future - the Visionarium', start: 'March 7, 2014', startdt: '20143-7', end: 'March 7, 2014', enddt: '2014-3-7',  leader: 'English, Mary',  credits: '1',  section: 431, role: 'learner'},
    ...
    {title: 'Seven Technology Tools to Use in Your Teaching Today', start: 'Feb. 06, 2014', end: 'Feb. 6, 2014',  leader: 'Summers, Teggin',  credits: '1',  section: 313, role: 'learner'},
    ...
    {title: 'Designed Interaction Specialist Certificate', start: 'Feb. 4, 2014', end: 'April 15, 2014', startdt: '2014-2-4', enddt: '2014-2-4',  leader: 'Yaffe, Dan',  credits: '6*',  section: 430, role: 'learner'}
  ];
