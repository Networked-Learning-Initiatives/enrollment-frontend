...
angular.module('enrollmentFrontendApp').controller('ScheduleCtrl', ['$scope', '$routeParams', 'ngTableParams', '$filter', '$rootScope', 'Upcoming', function ($scope, $routeParams, ngTableParams, $filter, $rootScope, Upcoming) {
  $scope.schedule = [
    ...
    {title: 'Seven Technology Tools to Use in Your Teaching Today', start: 'Feb. 6, 2014', end: 'Feb. 6, 2014', startdt: '2014-2-6', enddt: '2014-2-6',  theme: 'None',  credits: '1',  section: 313, role: 'coordinator'},
    ...
    {title: 'Designed Interaction Specialist Certificate', start: 'April 15, 2014', end: 'April 15, 2014', startdt: '2014-4-15', enddt: '2014-4-15',  theme: 'Engaging Learners',  credits: '6*',  section: 430, role: 'learner'}
  ];
